  ...
  return (
    <div className="grid grid-cols-2 gap-6">
      <NumberField<FormValues>
        ...
        decimalScale={0}
        helperText={
          errs.maxBlogDescriptionLength?.message
            ? `${errs.maxBlogDescriptionLength.message}. Allowed range: 2000 to 15000 characters.`
            : "Allowed range: 2000 to 15000 characters per blog description"
        }
        showError={false}
